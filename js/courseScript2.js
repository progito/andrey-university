...
const courses = {
    ...
    pcjob: {
        ...
        url: "https://forms.yandex.ru/u/674d7c6e90fa7b825424c86b/",
        "tags": [
            { "icon": "fa-solid fa-laptop-code", "text": "Основы программирования" },
            { "icon": "fa-solid fa-keyboard", "text": "Основые термины и понятия" },
            { "icon": "fa-solid fa-rocket", "text": "Начало карьеры в IT" }
        ],
        faq: [
            { question: "Для кого этот курс?", answer: "Этот курс подходит для начинающих пользователей, которые хотят стартануть в IT-сфере." }
        ],
        program: [
            { module: "Введение", topics: [
                "Что такое программирование?",
                "Базовое понимание программ",
                "Алгоритм & Код",
                "Примеры из жизни"
            ] },
            { module: "Алгоритмы и Блок схемы", topics: [
                "Что такое алгоритм?",
                "Создание алгоритма",
                "Виды алгоритмов",
                "Примеры алгоритмов",
            ...
            { module: "Переменные и Типы данных", topics: [
            ...
            { module: "Условия и Ветвления", topics: [
                "Что такое условие?",
                "Принцип ветвления",
                "Логические операции",
                "Задачка на самопроверку"
            ] },
            { module: "В дополнение еще", topics: [
